...
type IAdminDo interface {
	...
	Unscoped() IAdminDo
	Create(values ...*models.Admin) error
	CreateInBatches(values []*models.Admin, batchSize int) error
	Save(values ...*models.Admin) error
	First() (*models.Admin, error)
	Take() (*models.Admin, error)
	Last() (*models.Admin, error)
	Find() ([]*models.Admin, error)
	FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*models.Admin, err error)
	FindInBatches(result *[]*models.Admin, batchSize int, fc func(tx gen.Dao, batch int) error) error
	Pluck(column field.Expr, dest interface{}) error
	Delete(...*models.Admin) (info gen.ResultInfo, err error)
	...
	FirstOrInit() (*models.Admin, error)
	FirstOrCreate() (*models.Admin, error)
	FindByPage(offset int, limit int) (result []*models.Admin, count int64, err error)
